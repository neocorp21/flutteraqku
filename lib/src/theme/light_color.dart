...
class LightColor {
  ...
  static const Color titleTextColor = const Color(0xff9c27b0);
  static const Color subTitleTextColor = const Color(0xff797878);

  static const Color lightBlue1 = Color(0xff9c27b0);
  static const Color lightBlue2 = Color(0xffd500f9);
  static const Color navyBlue1 = Color(0xff9c27b0);
  static const Color lightNavyBlue = Color(0xff6d7f99);
  static const Color navyBlue2 = Color(0xff9c27b0);

  static const Color yellow = Color(0xffd500f9);
  static const Color white2 = Color(0xfff1f1f3);
